...
async def test_auth_02():
    ...
    async with httpx.AsyncClient(timeout=10.0) as client:
        ...
        valid_data = {
            ...
            "password": "dummy",
        }  # test@example.com was created with 'dummy' hashed_password in previous code or DB
    ...
    print(
        "✅ [AUTH-02-6] 비로그인이 /home 직접 접근: ProtectedRoute.tsx L12-14에서 메인(/)으로 리다이렉트 처리 확인됨 (랜딩 페이지 노출)"
    )
